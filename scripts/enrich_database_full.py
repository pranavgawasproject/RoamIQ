...
def main():
    ...
    visas = [
        ...
        ("Saint Vincent and the Grenadines", "🇻🇨", 90, True, "$800", "1 year", "$50,000/yr", 183, "Saint Vincent & Grenadines Remote Work Permit allows 1-year stay with 0% tax on foreign income", "1-2 weeks", "ARRAY['Passport','Proof of $50,000/yr remote income','Police record','Health insurance']::text[]", "1-year renewable remote stay permit", "0% local personal income tax on foreign remote income", 800, "SVG Tourism / Ministry of National Security Portal")
    ]
    ...
    DELETE FROM public.listings WHERE id IN ('b1b2c3d4-0157-4000-8000-000000000157', 'b1b2c3d4-0158-4000-8000-000000000158', 'b1b2c3d4-0159-4000-8000-000000000159', 'b1b2c3d4-0160-4000-8000-000000000160', 'b1b2c3d4-0161-4000-8000-000000000161', 'b1b2c3d4-0162-4000-8000-000000000162', 'b1b2c3d4-0163-4000-8000-000000000163', 'b1b2c3d4-0164-4000-8000-000000000164');
    DELETE FROM public.cost_of_living WHERE city_id IN ('ostrava', 'craiova', 'zlin', 'siauliai', 'pilsen', 'maribor', 'szeged', 'kosice');
    DELETE FROM public.cities WHERE id IN ('ostrava', 'craiova', 'zlin', 'siauliai', 'pilsen', 'maribor', 'szeged', 'kosice');
    ...
    ('pilsen', 'Pilsen', 'Czech Republic', '🇨🇿', 'https://images.unsplash.com/photo-1541971875076-8f970d573be6?auto=format&fit=crop&w=1200&q=80', 'Europe', 4.7, 4.5, 4.8, 4.8, 4.6, 4.7, 4.5, 4.7, 1320, 260, 16, 'Mild', 'Good', 'High', 4.7, 140, 550, 9.00, 3.20, 260, 1.05),
    ('maribor', 'Maribor', 'Slovenia', '🇸🇮', 'https://images.unsplash.com/photo-1596422846543-75c6fc197f07?auto=format&fit=crop&w=1200&q=80', 'Europe', 4.7, 4.6, 4.9, 4.9, 4.5, 4.8, 4.4, 4.8, 1290, 275, 15, 'Mild', 'Good', 'Very High', 4.8, 135, 520, 8.50, 3.00, 275, 0.95),
    ('szeged', 'Szeged', 'Hungary', '🇭🇺', 'https://images.unsplash.com/photo-1551867633-194f125bddfa?auto=format&fit=crop&w=1200&q=80', 'Europe', 4.6, 4.7, 4.8, 4.7, 4.5, 4.7, 4.4, 4.6, 1180, 265, 17, 'Mild', 'Good', 'High', 4.6, 125, 470, 7.80, 2.70, 265, 0.90),
    ('kosice', 'Košice', 'Slovakia', '🇸🇰', 'https://images.unsplash.com/photo-1541971875076-8f970d573be6?auto=format&fit=crop&w=1200&q=80', 'Europe', 4.6, 4.6, 4.9, 4.8, 4.5, 4.6, 4.4, 4.7, 1260, 280, 15, 'Mild', 'Good', 'High', 4.7, 130, 510, 8.40, 2.90, 280, 1.00);
    ...
    ('pilsen', 550, 140, 320, 28, 20, 130, 38, 10, 184, 'West Bohemian tech & innovation hub featuring 260 Mbps fiber internet and vibrant cultural scene', 'Czech Zivno freelance business visa permits 1-year renewable stay with flat tax option', 'Pilsen main railway station connects directly to Prague Main Station in 80 minutes'),
    ('maribor', 520, 135, 310, 26, 19, 125, 36, 10, 179, 'Slovenia second-largest tech & university hub with 275 Mbps gigabit fiber internet and Alpine views', 'Slovenia Remote Worker Residence Permit allows 1-year renewable stay', 'Maribor main railway station connects directly to Ljubljana and Graz'),
    ('szeged', 470, 125, 290, 24, 18, 115, 34, 10, 164, 'Southern Hungarian university & tech hub featuring 265 Mbps gigabit fiber and high sunlight hours', 'Hungary White Card digital nomad visa permits 1-year renewable stay with tax exemption', 'Szeged train station connects directly to Budapest Nyugati in 2 hours'),
    ('kosice', 510, 130, 305, 27, 20, 120, 35, 10, 173, 'East Slovakian IT valley & tech hub featuring 280 Mbps ultra-fast fiber internet and Gothic architecture', 'Slovakia Freelance & Digital Nomad Residence Permit permits 1-year renewable stay', 'Košice International Airport (KSC) connects directly to Vienna and Prague');
    ...
    ('b1b2c3d4-0161-4000-8000-000000000161', 'Pilsen Tech & Nomad Workspace', 'Pilsen Tech & Nomad Workspace — West Bohemian Tech Studio', 'coworking', 'Americká 42', 'Pilsen', 'Plzeň Region', 'Czech Republic', 'Europe', '260 Mbps', true, true, '€140/mo', 4.8, 31, true, true, 'Premier West Bohemian tech coworking space in central Pilsen featuring 260 Mbps high-speed fiber Wi-Fi, ergonomic standing desks, acoustic call booths, and craft coffee bar.', '260 Mbps Fiber, Ergonomic Workstations, Soundproof Call Pods, Craft Espresso Bar, 24/7 Access'),
    ('b1b2c3d4-0162-4000-8000-000000000162', 'Maribor Alpine Coworking Hub', 'Maribor Alpine Coworking Hub — Drava Tech Innovation Lounge', 'coworking', 'Gosposka ulica 15', 'Maribor', 'Styria', 'Slovenia', 'Europe', '275 Mbps', true, true, '€135/mo', 4.9, 33, true, true, 'Modern Styrian tech coworking studio in central Maribor featuring 275 Mbps gigabit fiber internet, sunlit focus rooms, podcast studio, and specialty coffee lounge.', '275 Mbps Gigabit Fiber, Sunlit Focus Rooms, Acoustic Call Pods, Artisan Coffee Lounge, 24/7 Access'),
    ('b1b2c3d4-0163-4000-8000-000000000163', 'Szeged Innovation Nomad Lab', 'Szeged Innovation Nomad Lab — Sunshine Tech & University Hub', 'coworking', 'Kárász utca 10', 'Szeged', 'Csongrád-Csanád', 'Hungary', 'Europe', '265 Mbps', true, true, '€125/mo', 4.8, 28, true, true, 'Vibrant southern Hungarian coworking studio in central Szeged featuring 265 Mbps gigabit fiber internet, standing desks, soundproof phone booths, and specialty espresso bar.', '265 Mbps Fiber, Ergonomic Workstations, Soundproof Booths, Specialty Espresso Bar, 24/7 Access'),
    ('b1b2c3d4-0164-4000-8000-000000000164', 'Košice IT Valley Digital Lab', 'Košice IT Valley Digital Lab — East Slovakian Tech Innovation Hub', 'coworking', 'Hlavná 68', 'Košice', 'Košice Region', 'Slovakia', 'Europe', '280 Mbps', true, true, '€130/mo', 4.9, 35, true, true, 'Premier East Slovakian IT Valley coworking studio in central Košice featuring 280 Mbps ultra-fast gigabit fiber Wi-Fi, modern lounges, acoustic booths, and specialty coffee bar.', '280 Mbps Gigabit Fiber, Modern Lounge, Soundproof Call Pods, Artisan Coffee Bar, 24/7 Access');
    ...
    UPDATE public.visa_info SET
      ...
      dn_visa_cost = '$800',
      dn_visa_duration = '1 year',
      min_income = '$50,000/yr',
      tax_residency_days = 183,
      tax_notes = 'Saint Vincent & Grenadines Remote Work Permit allows 1-year stay with 0% tax on foreign income',
      processing_time = '1-2 weeks',
      required_docs = ARRAY['Passport','Proof of $50,000/yr remote income','Police record','Health insurance']::text[],
      path_to_residency = '1-year renewable remote stay permit',
      tax_exemption_status = '0% local personal income tax on foreign remote income',
      application_fee_usd = 800,
      application_method = 'SVG Tourism / Ministry of National Security Portal'
    WHERE country = 'Saint Vincent and the Grenadines';

    INSERT INTO public.visa_info (country, flag, tourist_days, has_dn_visa, dn_visa_cost, dn_visa_duration, min_income, tax_residency_days, tax_notes, processing_time, required_docs, path_to_residency, tax_exemption_status, application_fee_usd, application_method)
    SELECT 'Saint Vincent and the Grenadines', '🇻🇨', 90, true, '$800', '1 year', '$50,000/yr', 183, 'Saint Vincent & Grenadines Remote Work Permit allows 1-year stay with 0% tax on foreign income', '1-2 weeks', ARRAY['Passport','Proof of $50,000/yr remote income','Police record','Health insurance']::text[], '1-year renewable remote stay permit', '0% local personal income tax on foreign remote income', 800, 'SVG Tourism / Ministry of National Security Portal'
    WHERE NOT EXISTS (SELECT 1 FROM public.visa_info WHERE country = 'Saint Vincent and the Grenadines');
    """
