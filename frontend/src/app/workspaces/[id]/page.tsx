...
export default async function WorkspaceDetailPage({
  ...
  if (listedPriceRange) localBusinessJsonLd.priceRange = listedPriceRange;
    ...
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <main className="flex-1 pt-28 sm:pt-32">
        ...
        <div className="mx-auto max-w-6xl px-5 sm:px-8">
          <Link href="/workspaces" className="inline-flex items-center gap-1.5 text-sm font-medium text-muted-foreground hover:text-foreground transition-colors">
