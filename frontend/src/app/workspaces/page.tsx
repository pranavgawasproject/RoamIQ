...
async function getListings(params: {
  ...
  try {
    ...
    const fetchTo =
      unfilteredFirstPage || photographedOnly || contactableOnly || hoursOnly || addressedOnly || mappedOnly ? Math.max(to, PAGE_SIZE * 4 - 1) : to;
...
export default async function WorkspacesPage({
  ...
  searchParams: Promise<{ search?: string; type?: string; city?: string; country?: string; min_wifi?: string; described?: string; priced?: string; photographed?: string; contactable?: string; hours?: string; addressed?: string; mapped?: string; page?: string }>;
}) {
