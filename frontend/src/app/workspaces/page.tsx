...
async function getListings(params: {
  ...
  try {
    ...
    const fetchTo =
      unfilteredFirstPage || photographedOnly || logoedOnly || contactableOnly || hoursOnly || addressedOnly || mappedOnly || equippedOnly || websiteOnly || socialOnly || reviewedOnly || phonedOnly || sizedOnly ? Math.max(to, PAGE_SIZE * 4 - 1) : to;
    ...
    const scored = rows
      .map((listing, index) => {
        ...
        if (usefulListingCapacity(listing.capacity)) score += 5;
